...
// let firstNumberArray = [2, 0, 4, 0, 6, 8, 0, 0, 18, 0, 24, 31];
//
// function moveZero(someArray) {
//
//     let distribution = someArray.length
//
//     for (let i = 0; i < distribution; i++) {
//
//         if (someArray[i] === 0) {
//
//             someArray.push(someArray[i]);
//
...
// }
//
// let resultArray = moveZero(firstNumberArray);
//
...
// let resultArray = [];
//
// function stringNormalize(someString) {
//
//     let trim = someString.trim();
//
//     let stringArray = trim.split(' ');
//
...
//         if (someString === '') {
//
//             let number = stringArray.indexOf(someString);
//
//             let splice = stringArray.splice(number, 1);
//
//         } else if (someString !== ''){
//
//             resultArray[resultArray.length] = someString;
//
//         }
//     }
...
// }
//
// let stringResult = stringNormalize(n1);
//
...
// function setString() {
//
//     document.write(`<div>"Hello owu!"</div>`)
//
// }
//
// setString();
...
// function setString(element,text) {
//
//     document.write(`<${element}>${text}</${element}>`)
//
// }
//
// setString("p",'Welcome to my resolve!!!');


// - приймає масив автомобілів (можна взяти з попередніх дз ),та ідентифікатор елементу в який потрібно додати список цих автомобілів............................................
...
// ];
//
// function setCars(someArray, element) {
//
...
//         let car = someArray[i];
//
//         document.write(`<li>${car.name} - ${car.year} -  ${car.producing_country}</li>`);
//
//     }
//     document.write(`<${element}>`);
// }
